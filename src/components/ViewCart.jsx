    ...
    return (
        <div className="container-fluid ">
            ...
            <form onSubmit={handleSubmit}  className="flex">           
                ...
                <div className="form-group form-row">
                    <label className="col-sm-2 form-control-label">Card No</label>
                    <div className="col-sm-6">
                        <input type="text" name="cardno" value={payment.cardno} onChange={handlePaymentInput} className="form-control" maxLength="16" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-2 form-control-label">Name on Card</label>
                    <div className="col-sm-6">
                        <input type="text" name="nameoncard" value={payment.nameoncard} onChange={handlePaymentInput} className="form-control" required/>                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-2 form-control-label">Expiry Date</label>
                    <div className="col-sm-6">
                        <input type="month" required className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-2 form-control-label">CVV</label>
                    <div className="col-sm-6">
                        <input type="number" name="cvv" maxLength="3" value={payment.cvv} onChange={handlePaymentInput} className="form-control" required/>                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-2 form-control-label">Billed Amount</label>
                    <div className="col-sm-6">
